...
class parallel_access
{
   ...
   typedef boost::function2<shared_ptr<my_msg_aspect_test> , shared_ptr<my_msg_aspect_test> , shared_ptr<my_msg_aspect_test> > reduction;
...
public:
   ...
   void simple_work_thread()
   {
      strict_lock<application::aspect_map> guard(my_aspect_map_); 
      {
         ...
         boost::shared_ptr<my_msg_aspect_test> myaspect = my_aspect_map_.find<my_msg_aspect_test>(guard);

         BOOST_CHECK(myaspect);

         my_aspect_map_.erase<my_msg_aspect_test>(guard);

         BOOST_CHECK((!my_aspect_map_.find<my_msg_aspect_test>(guard)));

         my_aspect_map_.insert<my_msg_aspect_test>(boost::make_shared<my_msg_aspect_test>("HI"), guard);

         my_aspect_map_.exchange<my_msg_aspect_test>(boost::make_shared<my_msg_aspect_test>("HI_REPLACED"), guard);

         BOOST_CHECK((my_aspect_map_.find<my_msg_aspect_test>(guard)->say_hi() == "HI_REPLACED"));

         reduction rf = &my_reduction_function;

         my_aspect_map_.reduce<my_msg_aspect_test, reduction >(boost::make_shared<my_msg_aspect_test>("HI"), rf, guard);
      }
   }
...
/*
...

   {
      ...
      my_aspect_map.erase<my_msg_aspect_test>();
...

   {
      ...
      application::aspect_map my_aspect_map;
      my_aspect_map.insert<my_msg_aspect_test>(boost::make_shared<my_msg_aspect_test>("HI"));
      my_aspect_map.reduce<my_msg_aspect_test, reduction >(boost::make_shared<my_msg_aspect_test>("HI"), rf);
...

   {
      ...
      // atomic
      {
         my_aspect_map.insert<my_msg_aspect_test>(boost::make_shared<my_msg_aspect_test>("HI"), guard);

         boost::shared_ptr<my_msg_aspect_test> myaspect = my_aspect_map.find<my_msg_aspect_test>(guard);

         BOOST_CHECK(myaspect);

         my_aspect_map.erase<my_msg_aspect_test>(guard);

         BOOST_CHECK(!my_aspect_map.find<my_msg_aspect_test>(guard));

         my_aspect_map.insert<my_msg_aspect_test>(boost::make_shared<my_msg_aspect_test>("HI"), guard);

         my_aspect_map.exchange<my_msg_aspect_test>(boost::make_shared<my_msg_aspect_test>("HI_REPLACED"), guard);

         BOOST_CHECK(my_aspect_map.find<my_msg_aspect_test>(guard)->say_hi() == "HI_REPLACED");

         my_aspect_map.reduce<my_msg_aspect_test, reduction >(boost::make_shared<my_msg_aspect_test>("HI"), rf, guard);

         BOOST_CHECK(my_aspect_map.find<my_msg_aspect_test>(guard)->say_hi() == "HI_REPLACED : HI");
      }
   }
